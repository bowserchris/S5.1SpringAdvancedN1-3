...
public class CommonConstants {
	...
	//Software INFO
		public static final String SOFTWARE_NAME = "Flower Shop\u2122";
		
		//URL mappings for authentication controller
		//start with /auth
		public static final String ORIGIN = "http://localhost:9001";
		public static final String FLOWER_INDEX = "/flower";
		
		public static final String ID = "/{id}";
		public static final String ADD_FLOWER = "/add";					
		public static final String GET_ALL_FLOWERS = "/getAll"; 
		public static final String UPDATE_FLOWER = "/update" + ID;
		public static final String DELETE_FLOWER = "/delete" + ID;
		public static final String GET_FLOWER = "/getOne" + ID;
